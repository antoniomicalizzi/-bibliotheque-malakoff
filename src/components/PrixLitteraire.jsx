        ...
        <div className="each-slide">
          ...
          <div className="each-slide">
            <div>
              ...
              <p>Le prix Mini et Maxi Bulles.<br/> En 2013, les 4 bibliothèques associatives (Lire, Expression-Livres, 1001 pages et l’Espace lecture) ont mis en place un prix BD jeunesse pour les 9-12 ans, à l’instar de celui proposé aux adultes.<br/> Puis, 2 ans après, ce prix a été étendu aux élèves de collèges avec le prix Maxi bulles (12-15 ans).<br/> Les médiatrices du livre sélectionnent 10 BD pour chacune de ces tranches d’âge.<br/> L’objectif de ce prix étant d’ouvrir les jeunes à ce 9ème Art tant par la diversité des thématiques, que par la diversité esthétique des formats proposés.</p>
            </div>
          </div>
          <div className="each-slide">
            <div>
