      ...
      <Header />
        <NavigationBox />
          <div className="edito">
            ...
            <p><strong>L’Espace Lecture, bibliothèque associative nantaise.</strong>Située au sein du quartier Malakoff, l’Espace Lecture est une des quatre bibliothèques associatives conventionnées par la ville de Nantes. Elle contribue à favoriser l’intérêt et le goût pour la lecture au plus près du public.</p>
            <p><strong>Lieu de rencontre et de culture.</strong>Située au sein du quartier Malakoff, l’Espace Lecture est une des quatre bibliothèques associatives conventionnées par la ville de Nantes. Elle contribue à favoriser l’intérêt et le goût pour la lecture au plus près du public.</p>
            ...
            <p><strong>Lieu de convivialité et de richesse.</strong>Grâce à Nathalie et Sandrine, médiatrices du livre qui coordonnent une équipe de 10 bénévoles, cet espace bibliothèque est un endroit  accueillant et chaleureux. Il offre au public des ouvrages diversifiés sélectionnés par leur soin et des conseils très personnalisés. Il permet à ses lecteurs petits et grands d’évoluer et de s’enrichir en participant par exemple à différents prix en fonction de leur niveau et de leur goût. Plus qu’une bibliothèque, l’Espace Lecture est un lieu de vie et de rencontre où se croisent des gens tous animés par une même pensée: toute lecture est un enrichissement.</p>

            <p className='citation'> « La lecture est importante. Si vous savez lire, alors le monde s’offre à vous. »
            Barack Obama
            </p>
    
            <p><strong>Lieu de médiation culturelle</strong>L’Espace Lecture donne également à ses lecteurs la possibilité de participer à différents prix littéraires. Elle accueille des rencontres d’auteurs, participe aux projets du quartier et de la ville et tisse des liens avec de nombreux partenaires.</p>
            
            <p><strong>Lieu d’espoir et de solidarité</strong>Le 5 juillet 2018, la bibliothèque associative Espace Lecture avait entièrement brûlé, à la Maison des Haubans, suite aux émeutes urbaines. Ses 13 000 ouvrages étaient partis en fumée. Grâce à un énorme élan de solidarité venu de toute part, Région, Ville, éditeurs, auteurs, particuliers, l’équipe a pu reconstituer un fonds, récupérer des meubles et un lieu qui lui ont permis de repartir sur de nouvelles bases. 
